...
public:
    ...
    __both__ virtual Color GetBRDF( const ShadePoint& sp, const Vector3& wo, const Vector3& wi ) const = 0;
    ...
    /// <param name="sp">The shade point information.</param>
    /// <param name="wo">The outgoing, reflected light direction.</param>
    __both__ virtual Color GetBHR( const ShadePoint& sr, const Vector3& wo ) const = 0;
    ...
    __both__ Color Sample( const ShadePoint& sp, Vector3& wo, const Vector3& wi ) const = delete;
};
