...
public:
    ...
    virtual Color GetBRDF( const ShadePoint& sp, const Vector3& wi, const Vector3& wo ) const = 0;
    ...
    /// <param name="wo">The outgoing, reflected light direction.</param>
    virtual Color Sample( const ShadePoint& sp, Vector3& wi, const Vector3& wo ) const = 0;
