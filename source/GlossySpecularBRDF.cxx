#include <rex/BRDFs/GlossySpecularBRDF.hxx>
...
// create g-s BRDF w/ coefficient, color, power, sampler
GlossySpecularBRDF::GlossySpecularBRDF( real32 ks, const Color& color, real32 pow, Handle<Sampler>& sampler )
    : BRDF( sampler )
{
    _ks = ks;
    _color = color;
...
// sample BRDF (sample_f)
Color GlossySpecularBRDF::Sample( const ShadePoint& sp, Vector3& wo, const Vector3& wi ) const
{
    // TODO : Temporary?
    return Color::Magenta;
}
